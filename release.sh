...
cp "$ROOT"/install.sh "$ROOT"/uninstall.sh "$ROOT"/rollback.sh "$STAGE/ruijie-panel/"
chmod 755 "$STAGE/ruijie-panel"/api/*.sh "$STAGE/ruijie-panel/init.d/ruijie-panel" \
    "$STAGE/ruijie-panel/install.sh" "$STAGE/ruijie-panel/uninstall.sh" "$STAGE/ruijie-panel/rollback.sh"
